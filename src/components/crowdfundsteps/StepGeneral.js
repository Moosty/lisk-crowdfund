...
export const StepGeneral = withReducer(
  "setGeneral",
  reducer
)((props) => {
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        onChange={(e) =>
          dispatch(Actions.updateCrowdfundForm({ description: e.target.value }))
        }
        variant="outlined"
        fullWidth
        style={{ marginBottom: 12 }}
      ...
      <TextField
        ...
        value={form.category}
        onChange={(e) =>
          dispatch(Actions.updateCrowdfundForm({ category: e.target.value }))
        }
